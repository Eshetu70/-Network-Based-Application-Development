...
const {validateId, validateEvents, validateResult } =require('../middlewares/validator')
...
router.post('/:id/rsvp', isLoggedIn, validateId, controller.status);

// router.put('/:id', isLoggedIn, validateId,controller.updateStatus);
